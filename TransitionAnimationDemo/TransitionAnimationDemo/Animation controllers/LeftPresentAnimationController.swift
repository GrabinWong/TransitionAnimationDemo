...
class LeftPresentAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    
    let interactionController: LeftPresentInterationController?
    
    init(interactionController: LeftPresentInterationController?) {
