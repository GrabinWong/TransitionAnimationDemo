...
class RightDismissAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    
    let interactionController: RightDismissInterationController?
    
    init(interactionController: RightDismissInterationController?) {
